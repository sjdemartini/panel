const appName = 'Panel'
const appCacheName = 'Panel-0.14.0';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/0.14.0/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
